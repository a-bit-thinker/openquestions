...
- Repo-wide history: steiner_logs_smoke_gsfix/run_20260222_smoke_gsfix/REPO_WIDE_HISTORY.md
- Global research log (all runs round1): steiner_logs_smoke_gsfix/RESEARCH_LOG.md
- Global practice log (all runs round2-5): steiner_logs_smoke_gsfix/PRACTICE_LOG.md
- Local paper notes: steiner_logs_smoke_gsfix/PAPER_NOTES.md
