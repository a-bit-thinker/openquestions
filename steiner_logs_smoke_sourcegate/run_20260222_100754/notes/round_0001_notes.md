...
- Repo-wide history: steiner_logs_smoke_sourcegate/run_20260222_100754/REPO_WIDE_HISTORY.md
- Global research log (all runs round1): steiner_logs_smoke_sourcegate/RESEARCH_LOG.md
- Global practice log (all runs round2-5): steiner_logs_smoke_sourcegate/PRACTICE_LOG.md
- Global research paper (paper-style synthesis): steiner_logs_smoke_sourcegate/RESEARCH_PAPER.md
- Existence frontier report (all admissible triples): steiner_logs_smoke_sourcegate/EXISTENCE_FRONTIER.md
- Local paper notes: steiner_logs_smoke_sourcegate/PAPER_NOTES.md
...
- PDF:
- Extracted text path:
- Method extracted (concrete lemma/algorithm):
- Implementation delta in this loop:
