...
- Repo-wide history: steiner_logs_smoke_round1gate_off/run_20260222_045946/REPO_WIDE_HISTORY.md
- Global research log (all runs round1): steiner_logs_smoke_round1gate_off/RESEARCH_LOG.md
- Global practice log (all runs round2-5): steiner_logs_smoke_round1gate_off/PRACTICE_LOG.md
- Global research paper (paper-style synthesis): steiner_logs_smoke_round1gate_off/RESEARCH_PAPER.md
- Existence frontier report (all admissible triples): steiner_logs_smoke_round1gate_off/EXISTENCE_FRONTIER.md
- Local paper notes: steiner_logs_smoke_round1gate_off/PAPER_NOTES.md
