...
- Repo-wide history: steiner_logs_smoke_round1gate_fail/run_20260222_045854/REPO_WIDE_HISTORY.md
- Global research log (all runs round1): steiner_logs_smoke_round1gate_fail/RESEARCH_LOG.md
- Global practice log (all runs round2-5): steiner_logs_smoke_round1gate_fail/PRACTICE_LOG.md
- Global research paper (paper-style synthesis): steiner_logs_smoke_round1gate_fail/RESEARCH_PAPER.md
- Existence frontier report (all admissible triples): steiner_logs_smoke_round1gate_fail/EXISTENCE_FRONTIER.md
- Local paper notes: steiner_logs_smoke_round1gate_fail/PAPER_NOTES.md
