...
- Repo-wide history: steiner_logs_smoke_sourcegate_tight/run_20260222_101554/REPO_WIDE_HISTORY.md
- Global research log (all runs round1): steiner_logs_smoke_sourcegate_tight/RESEARCH_LOG.md
- Global practice log (all runs round2-5): steiner_logs_smoke_sourcegate_tight/PRACTICE_LOG.md
- Global research paper (paper-style synthesis): steiner_logs_smoke_sourcegate_tight/RESEARCH_PAPER.md
- Existence frontier report (all admissible triples): steiner_logs_smoke_sourcegate_tight/EXISTENCE_FRONTIER.md
- Local paper notes: steiner_logs_smoke_sourcegate_tight/PAPER_NOTES.md
