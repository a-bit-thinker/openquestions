...
- Repo-wide history: steiner_logs_smoke_phaseb/run_phasebtest/REPO_WIDE_HISTORY.md
- Global research log (all runs round1): steiner_logs_smoke_phaseb/RESEARCH_LOG.md
- Global practice log (all runs round2-5): steiner_logs_smoke_phaseb/PRACTICE_LOG.md
- Global research paper (paper-style synthesis): steiner_logs_smoke_phaseb/RESEARCH_PAPER.md
- Existence frontier report (all admissible triples): steiner_logs_smoke_phaseb/EXISTENCE_FRONTIER.md
- Local paper notes: steiner_logs_smoke_phaseb/PAPER_NOTES.md
