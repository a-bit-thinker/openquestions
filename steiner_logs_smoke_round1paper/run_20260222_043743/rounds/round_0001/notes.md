...
- Repo-wide history: steiner_logs_smoke_round1paper/run_20260222_043743/REPO_WIDE_HISTORY.md
- Global research log (all runs round1): steiner_logs_smoke_round1paper/RESEARCH_LOG.md
- Global practice log (all runs round2-5): steiner_logs_smoke_round1paper/PRACTICE_LOG.md
- Global research paper (paper-style synthesis): steiner_logs_smoke_round1paper/RESEARCH_PAPER.md
- Existence frontier report (all admissible triples): steiner_logs_smoke_round1paper/EXISTENCE_FRONTIER.md
- Local paper notes: steiner_logs_smoke_round1paper/PAPER_NOTES.md
